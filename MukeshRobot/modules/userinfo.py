...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n❍ [<a href="https://t.me/ALL_SANATANI_BOT">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "• ʜᴇᴀʟᴛʜ •", url=f"https://t.me/ALL_SANATANI_BOT"
                            ),
                            InlineKeyboardButton(
                                "• ᴅɪsᴀsᴛᴇʀ •", url="https://t.me/Il_4ST_FIGHTER_lI"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "• ʜᴇᴀʟᴛʜ •", url="https://t.me/ALL_SANATANI_BOT"
                            ),
                            InlineKeyboardButton(
                                "• ᴅɪsᴀsᴛᴇʀ •", url="https://t.me/Il_4ST_FIGHTER_lI"
                            ),
...
INFO_HANDLER = DisableAbleCommandHandler(("ISinfo", "book"), info, run_async=True)
...
__mod_name__ = "ɪɴꜰᴏ"
__command_list__ = ["setbio", "bio", "setme", "me", "ISinfo"]
__handlers__ = [
    ID_HANDLER,
    GIFID_HANDLER,
    INFO_HANDLER,
