...
PING_HANDLER = DisableAbleCommandHandler("ISping", ISping, run_async=True)
PINGALL_HANDLER = DisableAbleCommandHandler("ISpingall", ISpingall, run_async=True)

dispatcher.add_handler(PING_HANDLER)
dispatcher.add_handler(PINGALL_HANDLER)

__command_list__ = ["ISping", "ISpingall"]
