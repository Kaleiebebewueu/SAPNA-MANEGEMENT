...
async def get_group_status(_, message: Message):
    if len(message.command) != 2:
        await message.reply("❖ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ɢʀᴏᴜᴘ ᴜsᴇʀɴᴀᴍᴇ ● Example ➥ `/groupinfo ʏᴏᴜʀɢʀᴏᴜᴘᴜsᴇʀɴᴀᴍᴇ`")
        return
    ...
    response_text = (
        ...
        f"❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➠ [ sʌᴘηʌ ꭙ ʀσʙσᴛ ˼ ♪](https://t.me/SAPNA_X_ROBOT)"
    )
